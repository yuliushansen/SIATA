<template>
    <div>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr >
                <td class="text-center" colspan="6"><h3>Laporan Sisa Stok</h3></td>
            </tr>
            <tr class="total">
                <td colspan="6"></td>
            </tr>
            <tr >
                <td class="text-left" colspan="6">Tahun : {{this.$route.params.tahun}}<br>Tipe Barang : {{this.$route.params.tipe}}</td>
            </tr>
            <table class="table">
                <tr  >
                <th>
        ...
        <div class="container mt-5">
            <line-chart v-bind:tahunEvent='$route.params.tahun' v-bind:tipe='$route.params.tipe'></line-chart>
        </div>
        <tr>
            <td></td>
        </tr>
...
import LineChart from './ChartStok.vue'
export default {
   ...
   created(){
    ...
    methods: {
        ...
        async showTransaksi(){
            this.tampung = await Controller.getlaporanstok(this.$route.params.tahun,this.$route.params.tipe);
