<template>
    <div>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr >
                <td class="text-center" colspan="6"><h3>Laporan Pendapatan Tahunan</h3></td>
            </tr>
            <table class="table">
                <tr  >
                <th>
...
export default {
   ...
   created(){
    ...
    methods: {
        ...
        async showTransaksi(){
            this.tampung = await Controller.getlaporanpendapatanpertahunbycabang();
            //alert("Register berhasil !!")
            this.laporan = this.tampung.data;
            this.jumlah=this.laporan.reduce((acc,item)=> acc+item.total_harga,0);
