<template>
    <div>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr >
                <td class="text-center" colspan="6"><h3>Laporan Penjualan Jasa</h3></td>
            </tr>
            <tr class="total">
                <td colspan="6"></td>
            </tr>
            <tr >
                <td class="text-left" colspan="6">Tahun : {{this.$route.params.tahun}}<br>Bulan : {{this.$route.params.bulan}}</td>
            </tr>
            <table class="table">
                <tr  >
                <th>
...
// import LineChart from './ChartPengeluaran.vue'
export default {
    name: 'laporanservice',
    data(){
       return{
...
//     },
   ...
   created(){
    ...
    methods: {
        ...
        async showTransaksi(){
            this.tampung = await Controller.getlaporanjasa(this.$route.params.tahun,this.$route.params.bulan);
